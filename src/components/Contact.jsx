              ...
              <div className="flex-1 flex flex-col gap-8 text-xs text-white/70 font-medium">
                ...
                <div className="flex flex-col sm:flex-row sm:justify-between sm:items-end gap-6">
                  <p className="max-w-[250px] leading-relaxed">
                    For urgent inquiries, reach me at <a href={`mailto:${personalInfo.emails.primary}`} className="underline hover:text-white transition-colors">{personalInfo.emails.primary}</a> or call <a href={`tel:${personalInfo.phone.replace(/ /g, '')}`} className="underline hover:text-white transition-colors whitespace-nowrap">{personalInfo.phone}</a>
                  </p>
